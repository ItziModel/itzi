...
def itzi_tutorial(grass_tutorial_session, tutorial_test_file):
    ...
    # Create raster mask
    gscript.run_command('r.watershed', elevation='elev_lid792_5m',
                        drainage='elev_lid792_5m_drainage')
    gscript.run_command('r.water.outlet', input='elev_lid792_5m_drainage',
                        output='watershed', coordinates='638888,220011')
    ...
    gscript.run_command('v.to.rast', input='watershed_out', type='point',
...
class TestItziTutorial:
    ...
    def test_tutorial_drainage(itzi_tutorial, test_data_path, test_data_temp_path, helpers):
        ...
        drainage_results = gscript.read_command('t.vect.db.select',
