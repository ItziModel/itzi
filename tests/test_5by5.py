...
@pytest.fixture(scope="module")
def sim_5by5_max_values(domain_5by5: Domain5by5Data) -> Simulation:
...
@pytest.fixture(scope="module")
def sim_5by5_stats(domain_5by5: Domain5by5Data, tmp_path_factory):
...
@pytest.fixture(scope="module")
def sim_5by5_open_boundaries(domain_5by5: Domain5by5Data, tmp_path_factory):
...
class TestOpenBoundaries:
    ...
    def test_boundary_flow_symmetry(self, sim_5by5_open_boundaries):
        ...
        for r, c in edge_cells:
            ...
            assert np.isclose(flow_val, sym_flow_val, atol=1e-6), (
...
@pytest.fixture(scope="module")
def sim_5by5_wse(domain_5by5: Domain5by5Data) -> Simulation:
...
class TestWSE:
    ...
    def test_water_depth_max(self, sim_5by5_wse):
        ...
        assert np.isclose(h_max, 0.2, atol=0.0001), (
            f"Max water depth should be ~0.2m, got {h_max:.3f}"
        )
    ...
    def test_wse_max(self, sim_5by5_wse):
        ...
        assert np.isclose(wse_max, 132.2, atol=0.0001), (
            f"Max WSE should be ~132.2m, got {wse_max:.3f}"
        )
    ...
    def test_wse_min(self, sim_5by5_wse):
        ...
        assert np.isclose(wse_min, 132.0, atol=0.0001), (
            f"Min WSE should be ~132m, got {wse_min:.3f}"
        )
